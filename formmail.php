...
$TARGET_EMAIL = array("^info@itamus\.com$");

            /* Help: http://www.tectite.com/fmdoc/def_alert.php */
define("DEF_ALERT","info@itamus.com");
...
function LoadBuiltinLanguage()
{
    ...
    $aMessages[MSG_LOG_OK] = 'OK';
        ...
        // Parameters: none
    $aMessages[MSG_THANKS_PAGE] = 'Thanks!  We\'ve received your suggestion ';
